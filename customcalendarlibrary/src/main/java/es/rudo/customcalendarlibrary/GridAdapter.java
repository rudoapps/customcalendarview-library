...
public class GridAdapter extends ArrayAdapter {
    ...
    public GridAdapter(Context context, List<CalendarDay> monthlyDates, Calendar currentDate, List<EventObjects> allEvents) {
    ...
    public Object getItem(int position) {
        return monthly_Dates.get(position);
    }

    @Override
    public int getPosition(Object item) {
        return monthly_Dates.indexOf(item);
    }
}